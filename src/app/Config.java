...
public class Config {
	...
	public static final float SUN_MASS = 900;
	...
	public static final float MASS_TO_SIZE_MULTIPLIER = 0.1f;

	public static final float NODE_MASS_CHANGE_RATE = 0.05f;
	public static final float NODE_INITIAL_MASS = 0.1f;
	// Too slow and new bodies will move directly into the sun, too fast and they will outrun gravity and escape
	public static final float NODE_DEFAULT_VELOCITY = 2.5f;
	
	public static final float MAX_DISTANCE_FROM_SUN = 5000;
